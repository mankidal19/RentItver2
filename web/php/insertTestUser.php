<?php
	include('config.php');
	$sql1 = "insert into rentalmaster(username,firstName,lastName, password, email,address1, address2, postcode,country,phone,state,city,cemail,cphone,title,gender,position,establishDate) values('rentalMaster','first','last','12345678','rentalmaster@gmail.com','address1','address2','postcode','country','0123546789','state','city','cemail','0123456789','title','gender','position','2017-10-29')";
